 ...
 *
 * Developing locally? First run `./gradlew :ktsearch-alert:publishToMavenLocal`, then swap the
 * `@file:DependsOn` line for:
 *
 *     @file:Repository("file:///home/you/.m2/repository")
 *     @file:DependsOn("com.jillesvangurp:ktsearch-alert:<local-version>")
 *
...
@file:DependsOn("com.jillesvangurp:ktsearch-alert:+")
