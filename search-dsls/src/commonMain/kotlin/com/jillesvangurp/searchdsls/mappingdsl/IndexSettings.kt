...
class IndexSettings : JsonDsl() {
    ...
    var maxResultWindow: Int by property("index.max_result_window")
    var maxInnerResultWindow: Int by property("index.max_inner_result_window")
    var maxRescoreWindow: Int by property("index.max_rescore_window")
    var maxDocvalueFieldsSearch: Int by property("index.max_docvalue_fields_search")
    var maxNgramDiff: Int by property("index.max_ngram_diff")
    var maxShingleDiff: Int by property("index.max_shingle_diff")
    var readOnly: Boolean by property("index.blocks.read_only")
    var readOnlyAllowDelete: Boolean by property("index.blocks.read_only_allow_delete")
    var readBlocked: Boolean by property("index.blocks.read")
    var writeBlocked: Boolean by property("index.blocks.write")
    var metadataBlocked: Boolean by property("index.blocks.metadata")
    var codec: String by property("index.codec")
    var hidden: Boolean by property("index.hidden")
    var priority: Int by property("index.priority")
    var defaultPipeline: String by property("index.default_pipeline")
    var finalPipeline: String by property("index.final_pipeline")
    var gcDeletes: Duration by property("index.gc_deletes")
    var searchIdleAfter: Duration by property("index.search.idle.after")
    var translogDurability: String by property("index.translog.durability")
    var translogSyncInterval: Duration by property("index.translog.sync_interval")
    var unassignedNodeLeftDelayedTimeout: Duration by property("index.unassigned.node_left.delayed_timeout")
    var totalFieldsLimit: Int by property("index.mapping.total_fields.limit")
    var depthLimit: Int by property("index.mapping.depth.limit")
    var nestedFieldsLimit: Int by property("index.mapping.nested_fields.limit")
    var nestedObjectsLimit: Int by property("index.mapping.nested_objects.limit")
    var fieldNameLengthLimit: Int by property("index.mapping.field_name_length.limit")
    var dimensionFieldsLimit: Int by property("index.mapping.dimension_fields.limit")
    var routingAllocationRequireName: String by property("index.routing.allocation.require._name")
    var routingAllocationIncludeTierPreference: String by property("index.routing.allocation.include._tier_preference")
    var routingAllocationExcludeName: String by property("index.routing.allocation.exclude._name")
    var routingRebalanceEnable: String by property("index.routing.rebalance.enable")
