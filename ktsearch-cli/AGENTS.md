...
- `ktsearch-cli/README.md` is generated by
  `ktsearch-cli/src/jvmTest/kotlin/com/jillesvangurp/ktsearch/cli/CliReadmeTest.kt`.
  Do not hand-edit `README.md`; change the generator test and regenerate.
